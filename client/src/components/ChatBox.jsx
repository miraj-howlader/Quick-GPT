...
const ChatBox = () => {
  const {user,setSelectedChat,axios,token,setUser,selectedChat,theme} = useAppContext()
  ...
  return (
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
     ...
     className='bg-primary/20 dark:bg-[#583C79] border border-primary dark:border-[#80609F]/30
     ...
     >
      ...
      <input type="text"  placeholder='Type your promt here...' 
